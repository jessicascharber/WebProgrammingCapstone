...
FileName:               emailform.php
Purpose:      This page connects to the database and stores the users' input
							to the email table of the cabindb database.
Input: 				emailform data from emailform.html
							customer information from email table of cabindb
							configFile.php
							connectOpenDb.php
Output:				INSERT  arrival, departure, lastname, firstname, streetaddress,
							city, state, zip, emailaddress, notes INTO email
							Display selected information
 -->
<html>
		<head>
			<title>Email Registration Sent</title>
...
/*  Database connections  */
					...
					$sql= "	INSERT INTO email (lastname, firstname, streetaddress, city, state, zip, emailaddress, notes)
					          VALUES ('$lastname','$firstname','$streetaddress','$city','$state','$zip','$emailaddress', '$notes')";
				/* Inserting values into the reservations table of the cabindb database	*/
					$result = mysqli_query($conn, $sql);
					$lastname = (isset($_POST['lastname'])    ? $_POST['lastname']   : '');
					$sql= "SELECT lastname, firstname, streetaddress, city, state, zip, emailaddress, notes from email WHERE lastname = '$lastname'";
					$result = mysqli_query($conn, $sql);
