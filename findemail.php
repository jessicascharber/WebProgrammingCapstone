			...
			<div id="page" data-role="page" data-theme="b" >
		    	...
		    	<div id="div1">
		      	...
		      	<div id="div2">
		        	...
		        	<h1>Camp Lake Cabin - Email Registration</h1>
		      	</div>
		    	</div>
				</div>
				<div data-role="content">
					...
					$sql= "SELECT * FROM `email` where lastname = '$lastname' ";
					...
					if (mysqli_num_rows($result) > 0) {
						...
						while($row = mysqli_fetch_assoc($result)) {
							...
							echo "<b>Email Address: " . $row["emailaddress"]. "</br><br>";
